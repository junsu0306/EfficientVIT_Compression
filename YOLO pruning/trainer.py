    ...
    def train(self):
        ...
        if world_size > 1 and "LOCAL_RANK" not in os.environ:
            ...
            try:
                ...
                env = os.environ.copy()
                env['PYTHONPATH'] = '/workspace/MH/YOLO:' + env.get('PYTHONPATH', '')
        ...
        while True:
            ...
            for i, batch in pbar:
                ...
                with autocast(self.amp):
                    ...
                    # Teacher forward
                    with torch.no_grad():
                        # self.model.eval() -> can change output 
                        ...
                        teacher_result = teacher_out[0]  # Extract teacher features
                    ...
                    # # KL divergence
                    # distil_loss = distillation_loss(student_logits, teacher_logits)
                    # distil_weight = 0.5
                    # self.loss += distil_weight * distil_loss
